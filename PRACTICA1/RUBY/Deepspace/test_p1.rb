...
botin = Deepspace::Loot.new(1,2,3,4,5)
...
escudo = Deepspace::ShieldBooster.new("nombre", 3.5, 3)
...
escudo_copia = Deepspace::ShieldBooster.newCopy(escudo)
...
sumin = Deepspace::SuppliesPackage.new(2.3, 4.5, 1.2)
...
for index in(0..99)
  ...
  if (dado2.firstShot == Deepspace::GameCharacter::ENEMYSTARSHIP)
    disp_prim[0]+= 1
  else
    disp_prim[1]+= 1
  end
